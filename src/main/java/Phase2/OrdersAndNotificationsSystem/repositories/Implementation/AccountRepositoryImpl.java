...
public class AccountRepositoryImpl implements AccountRepo {
    ...
    public AccountRepositoryImpl() {
        ...
        accounts.add(new Account("nourmuhamed", "123456", "nourmuhamed4@gmail.com", "01155500847",new Address("Dokki","Cairo","dd",16) , 400.00));
        accounts.add(new Account("mariamhaitham", "13456", "mariamhaitham36@gmail.com", "01126134834",new Address("Mokattam","Cairo","dd",8) , 500.50));
    }
